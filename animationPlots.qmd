...
Sequência de apresentação da função "x^t" com variação em "t". No *RStudio* essa sequência converge a uma animação.
:::
...
![Um quadro representativo do trecho de código acima, representando o movimento de um único ponto ao longo de uma expressão.](anim.plotsPontoVoando.png)
