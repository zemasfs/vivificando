...
rode o programa *Jmol* que está no computador ou numa mídia removível a partir de seu arquivo *Jmol.jar* após descompactação do arquivo baixado do próprio [site do *Jmol*](https://jmol.sourceforge.net/), e escolha do *Script Editor*
```{r, eval=FALSE}
...
![Exemplo do uso do *Script Editor* da versão instalada do *Jmol* em computador ou mídia removível.](scriptEditor.png)
